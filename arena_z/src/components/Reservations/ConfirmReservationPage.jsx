...
import TimePickerComponent from '../Reservations/TimePickerComponent';
                ...
                <form action="">
                    <div className={styles.inputContainer}>
                        ...
                        <div className={styles.inputWrapper}>
                            <input type="text" placeholder='Nome' name='establishmentCep' onChange={(e) => setEstablishmentCep(e.target.value)} />
                        </div>
                    </div>
                    <div className={styles.inputContainer}>
                        <span>Valor (R$)</span>
                        <div className={styles.inputWrapper}>
                            <input type="text" placeholder='Valor' name='establishmentCep' onChange={(e) => setEstablishmentCep(e.target.value)} />
                        </div>
                    </div>
